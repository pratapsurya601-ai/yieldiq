...
# v_244 — Sanity-clamp window for revenue CAGR widened from
    ...
    {
        "version_id": "v_fy2025_quarterly_backfill_recompute_2026_06_13",
        "title_public": (
            "Quarterly fundamentals coverage refresh (FY2025)"
        ),
        "applied_at": datetime.now(timezone.utc),
        "scope": {
            "tickers": [
                "21STCENMGM", "3MINDIA", "A2ZINFRA", "AAREYDRUGS", "AARTECH", "AARTIPHARM", "ABINFRA",
                "ABLBL", "ABMINTLLTD", "ACCURACY", "ADANIGREEN", "ADANIPORTS", "ADL", "ADVAIT",
                "ADVENTHTL", "AEGISVOPAK", "AEROFLEX", "AETHER", "AFFORDABLE", "AGARWALEYE", "AGROPHOS",
                "AHLEAST", "AIAENG", "AIROLAM", "ALANKIT", "ALGOQUANT", "ALKALI", "ALKYLAMINE",
                "ALLCARGO", "ALMONDZ", "ALOKINDS", "AMBER", "ANDHRAPAP", "ANTHEM", "APARINDS",
                "APLAPOLLO", "APOLLO", "APOLLOPIPE", "APOLSINHOT", "APTUS", "AQYLON", "ARCHIDPLY",
                "ARENTERP", "ARSSBL", "ARTNIRMAN", "ASHOKAMET", "ASIANENE", "ASIANTILES", "ASKAUTOLTD",
                "ASMS", "ASTEC", "ASTRAMICRO", "ASTRAZEN", "ASTRON", "ATAM", "ATGL",
                "ATHERENERG", "ATLANTAELE", "ATLASCYCLE", "AVL", "AVROIND", "AXISCADES", "AYE",
                "AYMSYNTEX", "AZAD", "BAFNAPH", "BAJAJHIND", "BAJAJHLDNG", "BAJAJINDEF", "BALAMINES",
                "BALAXI", "BALPHARMA", "BANARBEADS", "BANG", "BANKA", "BASML", "BBOX",
                "BBTC", "BBTCL", "BCG", "BCLIND", "BDL", "BESTAGRO", "BHAGCHEM",
                "BHARATFORG", "BHEL", "BIGBLOC", "BIOCON", "BIOFILCHEM", "BIRLACABLE", "BIRLAMONEY",
                "BIRLANU", "BLUECOAST", "BLUESTARCO", "BLUSPRING", "BOMDYEING", "BORANA", "BORORENEW",
                "BOROSCI", "BOSCH-HCIL", "BRNL", "BSE", "BSHSL", "BTML", "BUILDPRO",
                "BYKE", "CAMLINFINE", "CANHLIFE", "CAPILLARY", "CAPTRUST", "CARBORUNIV", "CCHHL",
                "CEIGALL", "CEMPRO", "CENTURYPLY", "CESC", "CEWATER", "CGPOWER", "CLEANMAX",
                "COHANCE", "COMPUSOFT", "COMSYN", "CONSOFINVT", "COSMOFIRST", "COUNCODOS", "CPEDU",
                "CPPLUS", "CRAFTSMAN", "CRAMC", "CSLFINANCE", "CTE", "CYIENT", "CYIENTDLM",
                "DANGEE", "DAVANGERE", "DBEIL", "DBOL", "DCI", "DCM", "DCMSIL",
                "DECCANCE", "DEEDEV", "DELHIVERY", "DELPHIFX", "DHRUV", "DIACABS", "DIGITIDE",
                "DIGJAMLMTD", "DISHTV", "DIXON", "DJML", "DONEAR", "DREDGECORP", "DVL",
                "DWARKESH", "DYNAMATECH", "EASEMYTRIP", "EASTSILK", "EFCIL", "EIEL", "EIFFL",
                "ELLEN", "EMAMIPAP", "EMMVEE", "ENRIN", "ERIS", "ESSENTIA", "ESTER",
                "ETHOSLTD", "EVERESTIND", "FAIRCHEMOR", "FEDFINA", "FINKURVE", "FIRSTCRY", "FISCHER",
                "FLAIR", "FLEXITUFF", "FLUOROCHEM", "FOCUS", "FOODSIN", "FOSECOIND", "FRACTAL",
                "GANECOS", "GANGAFORGE", "GAYAPROJ", "GCSL", "GEMAROMA", "GENESYS", "GENUSPOWER",
                "GHCLTEXTIL", "GICL", "GKENERGY", "GKSL", "GLOSTERLTD", "GMRAIRPORT", "GOACARBON",
                "GOCLCORP", "GODAVARIB", "GODREJIND", "GOKEX", "GRAPHITE", "GRASIM", "GREAVESCOT",
                "GREENLAM", "GRINFRA", "GRPLTD", "GSFC", "GSLSU", "GUFICBIO", "GUJAPOLLO",
                "GUJTHEM", "GULFPETRO", "GULPOLY", "GVKPIL", "HALDER", "HATSUN", "HEADSUP",
                "HEALTHX", "HGINFRA", "HGS", "HIKAL", "HILTON", "HIMATSEIDE", "HIRECT",
                "HMT", "HNDFDS", "HONASA", "HSCL", "IGARASHI", "IGCL", "IGIL",
                "IITL", "INDIACEM", "INDIANCARD", "INDIASHLTR", "INDORAMA", "INDOSTAR", "INDOUS",
                "INDOWIND", "INNOVACAP", "INNOVISION", "INOXINDIA", "IRMENERGY", "ITCHOTELS", "ITDC",
                "ITI", "IZMO", "JAIBALAJI", "JAIPURKURT", "JAYSREETEA", "JBMA", "JHS",
                "JINDALPHOT", "JISLDVREQS", "JKIPL", "JLHL", "JNKINDIA", "JPOLYINVST", "JSFB",
                "JSWCEMENT", "JSWENERGY", "JSWHL", "JSWINFRA", "JTEKTINDIA", "JUBLCPL", "JYOTICNC",
                "KAKATCEM", "KALYANI", "KAVDEFENCE", "KAYNES", "KCP", "KCPSUGIND", "KEEPLEARN",
                "KEI", "KERNEX", "KHADIM", "KHAICHEM", "KICL", "KIMS", "KIOCL",
                "KIRLOSENG", "KITEX", "KMEW", "KMSUGAR", "KNRCON", "KOHINOOR", "KOPRAN",
                "KPEL", "KRIDHANINF", "KRISHANA", "KRISHNADEF", "KRITI", "KRITIKA", "KRN",
                "KRSNAA", "KRYSTAL", "KSB", "KSHINTL", "KSHITIJPOL", "KSR", "LAGNAM",
                "LAURUSLABS", "LAXMICOT", "LAXMIINDIA", "LEMERITE", "LENSKART", "LFIC", "LGEINDIA",
                "LIBAS", "LINDEINDIA", "LLOYDSME", "LMW", "LORDSCHLO", "LOTUSEYE", "LOVABLE",
                "LOYALTEX", "LPDC", "LT", "LUMAXIND", "LYKALABS", "LYPSAGEMS", "MAANALU",
                "MADHAV", "MADRASFERT", "MAGNUM", "MAHAPEXLTD", "MAHASTEEL", "MALUPAPER", "MANAKALUCO",
                "MANBA", "MANORG", "MARALOVER", "MARINE", "MASKINVEST", "MBAPL", "MBLINFRA",
                "MCL", "MEDICAMEQ", "MEGASTAR", "MFML", "MICEL", "MIDWESTLTD", "MINDACORP",
                "MIRCELECTR", "MMTC", "MOBIKWIK", "MODINATUR", "MODISONLTD", "MOHITIND", "MOKSH",
                "MONEYBOXX", "MOREPENLAB", "MOSCHIP", "MPHASIS", "MTARTECH", "MUKKA", "MURUDCERA",
                "MWL", "NAGREEKCAP", "NAGREEKEXP", "NAHARCAP", "NARMADA", "NAVINFLUOR", "NAVKARCORP",
                "NDGL", "NECCLTD", "NECLIFE", "NETWEB", "NETWORK18", "NEXTMEDIA", "NFL",
                "NGLFINE", "NIBE", "NIBL", "NITCO", "NITIRAJ", "NOCIL", "NORBTEAEXP",
                "NORTHARC", "NPST", "NSIL", "NTPC", "NTPCGREEN", "OAL", "OBCL",
                "OCCLLTD", "OFSS", "OIL", "OILCOUNTUB", "OLAELEC", "OMINFRAL", "OMNI",
                "ONEPOINT", "ONESOURCE", "ORCHASP", "ORCHPHARMA", "ORICONENT", "ORIENTALTL", "ORIENTLTD",
                "ORIENTTECH", "ORISSAMINE", "ORKLAINDIA", "OSIAHYPER", "OSWALAGRO", "PACEDIGITK", "PALREDTEC",
                "PANSARI", "PARSVNATH", "PASHUPATI", "PAVNAIND", "PAYTM", "PCJEWELLER", "PENINLAND",
                "PFOCUS", "PFS", "PINELABS", "PKTEA", "PLAZACABLE", "PNBGILTS", "PNCINFRA",
                "PNGJL", "POCL", "POLYMED", "POWERICA", "POWERINDIA", "PRAKASH", "PRAKASHSTL",
                "PREMEXPLN", "PRIMO", "PRITIKAUTO", "PRIVISCL", "PROSTARM", "PROZONER", "PRUDMOULI",
                "PTC", "PTCIL", "PVP", "PWL", "PYRAMID", "RACE", "RADAAN",
                "RADHIKAJWE", "RADICO", "RAJRILTD", "RAJSREESUG", "RAMANEWS", "RAMAPHO", "RAMASTEEL",
                "RAMKY", "RATNAMANI", "RAYMONDLSL", "RAYMONDREL", "RBZJEWEL", "RCF", "REDTAPE",
                "REFEX", "REGAAL", "REGENCERAM", "RELIABLE", "RENUKA", "REPCOHOME", "RETAIL",
                "RICOAUTO", "RKDL", "RKEC", "RMDRIP", "ROSSTECH", "RPPL", "RTNPOWER",
                "RUSHIL", "RVTH", "SAATVIKGL", "SADBHAV", "SADBHIN", "SALONA", "SALSTEEL",
                "SALZERELEC", "SANGAMIND", "SANOFICONR", "SANSERA", "SANSTAR", "SARVESHWAR", "SATIA",
                "SATIN", "SBC", "SBGLP", "SCHAEFFLER", "SCHNEIDER", "SCODATUBES", "SENCO",
                "SEPC", "SERVOTECH", "SGIL", "SGMART", "SHAH", "SHAHALLOYS", "SHALBY",
                "SHALPAINTS", "SHANTI", "SHAREINDIA", "SHILPAMED", "SHIVALIK", "SHRADHA", "SHREDIGCEM",
                "SHRINGARMS", "SHYAMMETL", "SICALLOG", "SIEMENS", "SIGACHI", "SIGIND", "SIGMAADV",
                "SIGNATURE", "SIMPLEXINF", "SINDHUTRAD", "SKFINDUS", "SKYGOLD", "SMCGLOBAL", "SMSPHARMA",
                "SOLARINDS", "SOLARWORLD", "SOLEX", "SOMATEX", "SPAL", "SPANDANA", "SPARC",
                "SPECTRUM", "SPENCERS", "SPMLINFRA", "STANLEY", "STAR", "STCINDIA", "STEELXIND",
                "STERTOOLS", "STLNETWORK", "STLTECH", "STUDDS", "SUDEEPPHRM", "SUMEETINDS", "SUMICHEM",
                "SUMIT", "SUNCLAY", "SUNDARAM", "SUNDRMBRAK", "SUPERHOUSE", "SUPERSPIN", "SUPREMEINF",
                "SURAJEST", "SURAKSHA", "SUTLEJTEX", "SVLL", "SYMPHONY", "TAKE", "TASTYBITE",
                "TATACHEM", "TATAPOWER", "TATVA", "TBOTEK", "TBZ", "TCIFINANCE", "TDPOWERSYS",
                "TEAMGTY", "TECHM", "TEGA", "TEMBO", "TEXMOPIPES", "THANGAMAYL", "THEMISMED",
                "THERMAX", "TICL", "TIINDIA", "TIL", "TIMKEN", "TINNARUBR", "TIRUPATIFL",
                "TITAGARH", "TMCV", "TMPV", "TOTAL", "TRANSWORLD", "TREJHARA", "TRITURBINE",
                "TRU", "TSFINV", "TTL", "TTML", "TVSELECT", "TVSHLTD", "TVSMOTOR",
                "TVSSRICHAK", "UBL", "UFLEX", "UGROCAP", "ULTRACEMCO", "UMESLTD", "UNIENTER",
                "UNIINFO", "UNIVCABLES", "UNOMINDA", "URBANCO", "URJA", "USK", "V2RETAIL",
                "VALIANTORG", "VARDMNPOLY", "VASCONEQ", "VASWANI", "VBL", "VERTOZ", "VIJAYA",
                "VIKASLIFE", "VINCOFE", "VINNY", "VIPIND", "VISASTEEL", "VLEGOV", "VMSTMT",
                "VOLTAS", "VSTL", "WAKEFIT", "WALCHANNAG", "WANBURY", "WEBELSOLAR", "WEL",
                "WELINV", "WEWORK", "WIPRO", "WOCKPHARMA", "XPROINDIA", "YASHO", "YUKEN",
                "ZAGGLE", "ZENITHEXPO", "ZIMLAB", "ZODIACLOTH", "ZYDUSWELL",
            ],
            "fields": ["*"],
        },
        "rationale": (
            "The FY2025 quarterly results (Mar/Jun/Sep 2025) were absent "
            "from the quarterly results store for a majority of the "
            "universe because an earlier one-shot backfill, run across "
            "the integrated-filing endpoint migration, completed only "
            "partially; those quarters have now been re-ingested. This "
            "entry invalidates the cached analysis rows for the affected "
            "tickers that still carry an insufficient-data verdict, so "
            "their next read recomputes on the complete quarterly "
            "history. Whole-payload scope is used because the added "
            "quarters shift trailing-twelve-month aggregates, growth "
            "rates, and the downstream valuation fields that depend on "
            "them."
        ),
    },
    {
