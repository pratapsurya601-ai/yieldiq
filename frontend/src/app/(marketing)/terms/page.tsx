    ...
    <div className="bg-bg dark:bg-surface text-ink min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-gray prose-sm max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">4. Subscription &amp; Payments</h2>
            <p className="text-caption leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">5. Intellectual Property</h2>
            <p className="text-caption leading-relaxed">
          ...
          {/* 6. Disclaimer */}
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">6. Disclaimer</h2>
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-sm text-red-800 leading-relaxed">
                <span className="font-bold">YieldIQ is NOT investment advice.</span> The Service is a quantitative
          ...
          {/* 9. Changes to Terms */}
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">9. Changes to Terms</h2>
            <p className="text-caption leading-relaxed">
