    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/search"
            className="inline-flex items-center justify-center px-4 py-2.5 min-h-[44px] bg-white text-gray-700 text-sm font-semibold rounded-xl border border-gray-200 hover:bg-gray-50 active:scale-[0.98] transition"
          >
            Search Stocks
          </Link>
        </div>
