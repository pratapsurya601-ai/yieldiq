...
export const METRIC_EXPLANATIONS: Record<string, MetricExplanation> = {
  ...
  fair_value: {
    ...
    good:
      "Compare to current price: well above price = undervalued, well below = overvalued. A DCF is only as good as its assumptions — treat it as a centre of gravity, not a precise number.",
  },
  current_price: {
    title: "Current Price",
    oneLine:
  ...
  mos: {
    ...
    good:
      "Above +30% is deep value, +10-30% is a decent cushion, -10% to +10% is roughly fair, below -20% is expensive. Benjamin Graham demanded ~33% before buying.",
  },
  bear_case: {
    title: "Bear Case",
    oneLine:
  ...
  verdict: {
    title: "Verdict",
    oneLine:
      "Our one-word summary of whether the stock is undervalued, fairly valued, or overvalued against its fair value.",
    good:
      "Undervalued (MoS > +15%), Fairly valued (-10% to +15%), Overvalued (< -10%). A verdict is not a recommendation — it's a valuation label.",
  },
  ...
  yieldiq_score: {
    ...
    good:
      "Above 75 = strong across the board, 55-75 = solid with trade-offs, 35-55 = mixed, below 35 = multiple concerns. It rewards both cheap AND high-quality — a stock can score low simply by being overpriced.",
  },
  grade: {
    title: "Grade",
    oneLine:
  ...
  moat_score: {
    title: "Moat Score",
    oneLine:
      "A 0-100 score for the strength of the company's competitive advantage, derived from ROCE consistency, margin stability, and market share.",
    good:
  ...
  roe: {
    ...
    good:
      "Above 20% is excellent, 15-20% solid, 10-15% average, below 10% weak. Sustained 20%+ ROE is the hallmark of a compounder.",
    sectorNote:
  ...
  roce: {
    ...
    good:
      "Above 20% is excellent, 15-20% solid, 10-15% average, below 10% weak. Unlike ROE, ROCE can't be faked with leverage — it's the purest measure of operating quality.",
    sectorNote:
      "Asset-light IT services routinely hit 30-50%+ (TCS, Infosys). Capital-heavy cement/steel sees 12-18% as strong. Compare within a sector, not across.",
  },
  roa: {
    ...
    good:
      "For Indian banks: above 1.4% is strong, around 1.0% is average, below 0.6% is weak. Top private banks (HDFC, Kotak) run 1.8-2.0%; PSU banks typically sit at 0.6-1.0%.",
  },
  ...
  current_ratio: {
    ...
    good:
      "Above 1.5 is comfortable, 1.0-1.5 is adequate, below 1.0 is a short-term liquidity concern. Too high (>3.0) can mean idle working capital.",
  },
  asset_turnover: {
    ...
    good:
      "Above 1.0 is strong, 0.5-1.0 is typical, below 0.3 means the business is capital-heavy (infra, utilities).",
    sectorNote:
  ...
  ev_ebitda: {
    ...
    good:
      "Below 10x is typically cheap, 10-15x reasonable, 15-25x full, above 25x expensive. Durable compounders often trade at 20-30x and still outperform.",
  },
  pe_ratio: {
    ...
    good:
      "Below 15x is typically cheap for Indian large caps, 15-25x normal, 25-40x premium, above 40x rich. Nifty 50 long-run average is ~22x.",
    sectorNote:
  ...
  revenue_cagr_3y: {
    ...
    good:
      "Above 15% is strong growth, 8-15% solid, 3-8% modest, below 3% stagnant. Compare to nominal GDP growth (~10-12%) as a baseline.",
  },
  revenue_cagr_5y: {
    ...
    good:
      "Above 15% is high-growth, 10-15% solid, 5-10% modest, below 5% mature/slow. 5-year CAGR should be the anchor — 3-year can flatter a cyclical peak.",
  },
  dividend_yield: {
  ...
  promoter_holding: {
    ...
    good:
      "Above 50% is strong promoter control, 25-50% moderate, below 25% low stake. Watch promoter pledge separately — pledged shares can be force-sold in a crunch.",
  },
  piotroski_score: {
    ...
    good:
      "7-9 = fundamentally strong, 4-6 = mixed, 0-3 = weakening. The F-score filters out value traps — cheap stocks with 7+ F-score historically beat cheap stocks with low F-score.",
  },
  ...
  nim: {
    ...
    good:
      "Indian banks: above 4% is strong (top private banks, small-finance banks), 3-4% healthy, 2.5-3% average for PSUs, below 2.5% compressed.",
  },
  car: {
  ...
  casa: {
    ...
    good:
      "Above 45% is excellent (SBI, HDFC, Kotak), 35-45% healthy, 25-35% typical for mid-sized banks, below 25% expensive funding profile.",
  },
  advances_yoy: {
  ...
  deposits_yoy: {
    ...
    oneLine:
      "Year-on-year growth in total deposits — the fuel that funds advances. Deposit growth should broadly keep pace with advances.",
    good:
  ...
  pat_yoy_bank: {
    ...
    good:
      "Above 20% is strong, 12-20% healthy, 5-12% modest, below 5% stagnant. In a clean credit cycle, good banks compound PAT at 15-25% for years.",
  },
}
