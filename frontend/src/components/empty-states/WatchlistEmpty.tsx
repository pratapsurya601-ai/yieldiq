...
export default function WatchlistEmpty() {
  // Day-37 (2026-05-20): added dark variants throughout. The empty-
  // state components are cold-start screens new users see — without
  // dark counterparts they rendered as bright light cards against
  // the dark layout.
  return (
