...
const TABS: NavTab[] = [
  {
    ...
    href: "/home",
    icon: (active) => (
      <svg className={cn("h-5 w-5", active ? "text-blue-600 dark:text-blue-400" : "text-caption")} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const MORE_ITEMS: MoreItem[] = [
  {
    ...
    icon: (
      <svg className="h-5 w-5 text-body" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
