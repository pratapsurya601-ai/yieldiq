...
export default function LearnTip({ tipKey }: LearnTipProps) {
  ...
  return (
    <div
      className={cn(
        "rounded-lg bg-blue-50 border border-blue-100 px-3 py-2 mt-1"
      )}
    >
      <div className="flex items-start gap-1.5">
        <svg className="h-3.5 w-3.5 text-blue-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
