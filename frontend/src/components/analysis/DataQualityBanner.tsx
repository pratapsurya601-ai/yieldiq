...
export default function DataQualityBanner({
  ...
  const bg = critical ? "bg-tone-bad-bg dark:bg-red-950/30" : "bg-tone-warn-bg dark:bg-amber-950/30"
  const border = critical ? "border-tone-bad-bd dark:border-red-900" : "border-tone-warn-bd dark:border-amber-900"
