...
const SEVERITY_CARD: Record<RedFlag["severity"], string> = {
  critical: "border-l-4 border-red-500 bg-tone-bad-bg dark:bg-red-950/30",
  warning: "border-l-4 border-yellow-500 bg-tone-warn-bg dark:bg-yellow-950/30",
  info: "border-l-4 border-green-500 bg-green-50 dark:bg-green-950/30",
}

const SEVERITY_BADGE: Record<RedFlag["severity"], string> = {
  critical: "text-tone-bad-fg dark:text-red-300",
  warning: "text-tone-warn-fg dark:text-yellow-300",
