 ...
 *
 * Until the direct NSE data path lands, we surface the status explicitly
 * so users typing "INFY" don't infer the model is simply broken.
 *
 * Day-93 (2026-05-22): removed expired "Fix ETA Q2 2026" copy — we
 * are currently IN Q2 2026 and the date had become a credibility tax.
 * Repair is in progress; users see active language instead of a stale
 * promise date.
 *
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0 text-sm leading-relaxed">
          <p>
            <span className="font-bold">Data Limited:</span> {bare} is on our
            ADR cross-listed cohort where upstream financial data has known
            quality issues. Repair is in progress — fair value and score may
            be conservative until the direct NSE data path lands.{" "}
            <a
